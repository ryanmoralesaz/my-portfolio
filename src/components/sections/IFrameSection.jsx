...
>
  {/* Title section */}
  <div
    className={`w-full md:w-1/5 flex items-center justify-center p-6 transition-all duration-1000 ease-out ${
      hasBeenVisible ? "translate-x-0 opacity-100" : "-translate-x-full opacity-0"
    }`}
  >
  ...
  {/* Content section */}
  <div
    className={`w-full md:w-2/5 p-8 flex flex-col justify-center transition-all duration-1000 ease-out delay-300 ${
  ...
  {/* Iframe section */}
  <div
    className={`w-full md:w-2/5 p-6 flex items-center justify-center transition-all duration-1000 ease-out delay-500 ${
      hasBeenVisible ? "translate-x-0 opacity-100" : "translate-x-full opacity-0"
    }`}
  >
